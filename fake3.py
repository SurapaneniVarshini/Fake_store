...
tree = ttk.Treeview(root, columns=('ProductID', 'Name', 'Price', 'Description', 'Quantity'), show='headings', yscrollcommand=scroll_bar.set)
...
# Configure the scroll bar to work with the treeview
