...
product_window = None  # Global variable for the product window
...
def select_product():
    ...
    if selected_item:
        ...
        messagebox.showwarning("No Product Selected", "Please select a product from the table.")

def show_product_window(product_id, selected_product, product_price):
    global product_window  # Make product_window a global variable
    ...
    quantity_label = tk.Label(product_window, text="Quantity:")
    quantity_label.pack()
...
def save_product(product_id, selected_product, product_price, quantity):
    global product_window  # Access the global product_window variable
